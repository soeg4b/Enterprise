    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4">
        ...
        <div className="px-6 py-5 space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder={`Paste ${selectedProvider.name} API key di sini…`}
                  className="w-full border border-slate-300 rounded-lg px-3 py-2.5 text-sm pr-16 focus:outline-none focus:ring-2 focus:ring-blue-500 font-mono"
                />
                <button
                  type="button"
          ...
          {/* Model & base URL (advanced, collapsible) */}
          <details className="group">
            <summary className="text-xs text-slate-500 cursor-pointer hover:text-slate-700 list-none flex items-center gap-1">
              ...
              Pengaturan Lanjutan (model, endpoint)
            </summary>
        ...
        <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-slate-200 bg-slate-50 rounded-b-2xl">
          <button onClick={onClose} className="text-sm text-slate-600 hover:text-slate-800 px-4 py-2">
            Batal
          </button>
          <button
            onClick={() => void handleSave()}
            disabled={saving || (selectedProvider.id !== 'ollama' && !apiKey.trim())}
            className="px-5 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold rounded-lg transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
          >
